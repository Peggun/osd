...
def home_page():
    ...
    return render_template("home_page/html/html-home.html", show_get_started=show_get_started)
...
def set_visited_cookie():
    ...
    response.set_cookie('visited', 'true', max_age=60*60*24*365)  # 1 year duration
    return response